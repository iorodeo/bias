...
namespace bias {
    ...
    enum ErrorCode 
    {
        ...
        ERROR_SPIN_GET_FLOAT_VALUE,
        ERROR_SPIN_SET_FLOAT_VALUE, 
        ERROR_SPIN_GET_FLOAT_MAX_VALUE,
        ERROR_SPIN_GET_FLOAT_MIN_VALUE,
        ERROR_SPIN_GET_FLOAT_UNIT,
        ERROR_SPIN_GET_INTEGER_VALUE,
        ERROR_SPIN_SET_INTEGER_VALUE,
        ERROR_SPIN_GET_INTEGER_MAX_VALUE,
