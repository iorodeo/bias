...
namespace bias {
    ...
    enum ErrorCode 
    {
        ...
        ERROR_SPIN_RETRIEVE_NODE_AVAILABLE,
        ERROR_SPIN_RETRIEVE_NODE_READABLE,
        ERROR_SPIN_RETRIEVE_NODE_TYPE,
        ERROR_SPIN_RETRIEVE_NODE_NAME,
        ERROR_SPIN_RETRIEVE_NODE_DISPLAY_NAME,
        ERROR_SPIN_RETRIEVE_NODE_TOOLTIP,
        ERROR_SPIN_RETRIEVE_NODE_DESCRIPTION,
        ERROR_SPIN_RETRIEVE_VENDOR_NAME,
        ERROR_SPIN_RETRIEVE_NUM_ENTRIES,
        ERROR_SPIN_RETRIEVE_ENUM_ENTRY_NODE,
        ERROR_SPIN_RETRIEVE_ENUM_ENTRY_VALUE,
        ERROR_SPIN_RETRIEVE_ENUM_ENTRY_INT_VALUE,
        ERROR_SPIN_RETRIEVE_STRING_VALUE,
